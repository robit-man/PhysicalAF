...
<style scoped>
.connect-wallet{text-align:center;font-size:1.5rem;padding:1rem;background:white;cursor:pointer;color:#3F3C40;font-weight:600;border-radius:0.5rem;}
.buttondesc{margin-bottom:0.5rem;}
.buttonmodal{padding:1rem;background:#3F3C40;border-radius:0.5rem;height: max-content;
margin: auto;}
