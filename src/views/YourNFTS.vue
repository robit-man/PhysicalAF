<template>
    <div class="fill-h-f column ">
        <div class="row  auto">
            <div class="hero-text" style="">
                <h2 style="font-size:3rem;transform:rotate(-14deg)">Your NFTs</h2>
            </div>
        </div>
    ...
    <Preview v-if="preview" v-show="preview" @close="closeModal">
    </Preview>
    
    <Checkout v-if="checkout" v-show="checkout" @close="closeModal">
    </Checkout>
</template>
